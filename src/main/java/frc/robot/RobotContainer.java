...
public final class RobotContainer {
  ...
  private ClimberSubsystem m_ClimberSubsystem = new ClimberSubsystem(new ClimberIOTalonFX(ClimberCostansts.climberMotorID));
  private ClawSubsystem m_ClawSubsystem = new ClawSubsystem(new ClawIOTalonFXS(ClawConstants.beambreakChannel, ClawConstants.motorControllerID));
  private ElevatorSubsystem m_ElevatorSubsystem = new ElevatorSubsystem(new ElevatorIOTalonFX(botType, ElevatorConstants.leftMotorID, ElevatorConstants.rightMotorID, ElevatorConstants.limitSwitchChannel));
  public PivotSubsystem m_PivotSubsystem = new PivotSubsystem(new PivotIOTalonFX(PivotConstants.motorID, PivotConstants.encoderID));
