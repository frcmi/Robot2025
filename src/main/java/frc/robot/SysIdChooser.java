...
public class SysIdChooser {
  ...
  public SysIdChooser(
    ...
    // sysIdChooser.addOption("Swerve Translation",
  ...
  public void updateCommands(SysIdRoutine routine) {
    ...
    quasistaticForward.setCommand(
        sysIdChooser.getSelected().quasistatic(SysIdRoutine.Direction.kForward));
    quasistaticReverse.setCommand(
        sysIdChooser.getSelected().quasistatic(SysIdRoutine.Direction.kReverse));
  }
