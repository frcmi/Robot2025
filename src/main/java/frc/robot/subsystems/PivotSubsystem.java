...
public class PivotSubsystem extends SubsystemBase {
    ...
    public PivotSubsystem(BotType bot, MechanismLigament2d elevatorLigament) {
        if (bot == BotType.MAIN_BOT) {
            pid = new ProfiledPIDController(PivotConstants.kRealBotP, PivotConstants.kRealBotI, PivotConstants.kRealBotD, new Constraints(PivotConstants.maxVelocity, PivotConstants.maxAccel));
            feedforward = new ArmFeedforward(PivotConstants.kRealBotS, PivotConstants.kRealBotG, PivotConstants.kRealBotV, PivotConstants.kRealBotA);
        } else if (bot == BotType.SIM_BOT) {
            pid = new ProfiledPIDController(PivotConstants.kSimulationBotP, PivotConstants.kSimulationBotI, PivotConstants.kSimulationBotD, new Constraints(PivotConstants.maxVelocity, PivotConstants.maxAccel));
            feedforward = new ArmFeedforward(PivotConstants.kSimulationBotS, PivotConstants.kSimulationBotG, PivotConstants.kSimulationBotV, PivotConstants.kSimulationBotA);
        }
